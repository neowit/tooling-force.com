...
/**
  ...
  *
  * original version based on old Apexcode.g4 grammar, not using ApexScanner
  */
class ListCompletions_Old extends ApexActionWithReadOnlySession with JsonSupport {
